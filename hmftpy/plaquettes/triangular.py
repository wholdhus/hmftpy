...
"""
Connection diagram for 24 site parallelogram
...
plaq24A = {'L': 24,
           'inner': {},
           'outer': {}}
plaq24A['outline'] = [0,5,11,17,23,18,12,6,0]
plaq24A['rs'] = [i*ax for i in range(6)] + [i*ax+a1 for i in range(6)] + [i*ax+a1+a2 for i in range(6)] + [i*ax+2*a1+a2 for i in range(6)]
plaq24A['Rs'] = [6*ax, 2*(a1+a2)]
plaq24A['inner']['n_bonds'] = [[0,1], [1,2], [2,3], [3,4], [4,5],
...
plaq24A['inner']['nn_bonds'] = [[0,7], [1,8], [2,9], [3,10], [4,11],
                                [6,14], [7,15], [8,16], [9,17],
                                ...
                                [14,18], [15,19], [16,20], [17,21]]
plaq24A['outer']['n_bonds'] = [[5,0], [11,6], [17,12], [23,18],
                               [11,12], [18,1], [19,2], [20,3], [21,4], [22,5], [23,0],
                               [0,11], [12,23], [18,0], [19,1], [20,2], [21,3], [22,4], [23,5]]
plaq24A['outer']['nn_bonds'] = [[5,6], [10,12], [11,13], [17,18], 
                                [18,2], [19,3], [20,4], [21,5], [22,0], [23,1],
                                # 
                                [12,0], [13,1], [14,2], [15,3], [16,4], [17,5], 
                                [18,6], [19,7], [20,8], [21,9], [22,10], [23,11],
                                #
                                [0,10], [1,11], [6,17], [12,22], [13,23],
                                [18,5], [19,0], [20,1], [21,2], [22,3], [23,4]]
...
if __name__ == '__main__':
    ...
    print('Checking plaq24A')
    print(test_bonds(plaq24A, [6,6]))